        ...
        {!isLoading ? (
          <img
            ...
            src={
              `${backgroundPrev}` ||
              `${background_image}` ||
              "/profile_pic_def/gooseCom_slim.png"
            }
            alt="background"
          />
        ) : (
      ...
      {!isLoading ? (
        ...
        >
          <div className="max-w-[300px] w-full flex items-center gap-3">
            <div>
              <Skeleton className="flex items-center inline-block rounded-full left-3 ring-4 ring-zinc-600 bg-zinc-400 h-36 w-36"></Skeleton>
            </div>
